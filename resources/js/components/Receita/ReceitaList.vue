  ...
  <div>
    <div id="list" class="p-2 drop-shadow-md border border-black-500 rounded ">
      ...
      <table class="w-4/5 h-full ">
        <thead class="p-2">
          <tr>
            <th colspan="5" class="text-2xl text-center">Receitas</th>
          </tr>
